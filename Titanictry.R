...
#add survived column to test so you can combine the data sets
...
#data types of data.combined

str(data.combined)

#change around the data types

data.combined$Pclass <- as.factor(data.combined$Pclass)
data.combined$Survived <- as.factor(data.combined$Survived)

#grass/individual survival
...
#correct train$pclass

#train$Pclass <- as.factor(train$Pclass)

#plot dependency of survival on class
...
#get the full record of the duplicate names
...
#look at miss and mister

misses <- data.combined[which(str_detect(data.combined$Name, "Miss.")), ]
misses[1:5,]

#corelation between title and age
#this time for mrs
...
write.csv(submit.df, file = "rf_basic.csv", row.names = FALSE)
